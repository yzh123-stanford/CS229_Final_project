...
def plot_input_data(btc_close, train_size, valid_size, test_size, input_window_length, forecast_horizon, width, height):
    ...
    valid_color = mcolors.to_rgba('skyblue')  
    test_color = mcolors.to_rgba('darkgreen')  
